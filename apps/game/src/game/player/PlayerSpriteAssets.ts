...
const playerSpriteRegistry: Record<string, ObjectSpriteAsset> = objectSpriteAssets;
...
export function getPlayerSpriteAsset(playerId = defaultPlayerSpriteId): ObjectSpriteAsset | undefined {
  return playerSpriteRegistry[playerId];
}

export function playerSpriteTextureKey(playerId = defaultPlayerSpriteId): string {
