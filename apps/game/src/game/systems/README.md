...
components through `World`, and they should stay focused on one job.

## Update Order

System order is registered in `../bootstrap/registerSystems.ts`.
...
live under `../actions`, while shared lookup logic should live in a small query
or helper module.
