...
export const biomeDefinitions: Record<string, BiomeDefinition> = {
  ...
  uniswap: {
    ...
    subtitle:
      "A lake, forest, city plain, and swamp shaped by liquidity routes.",
    description:
    ...
    objects: [
      ...
      biomeObject(
        ...
        56,
        301,
        ["unicorn-forest", "swap-city-plain"],
        ["grass", "forest-floor"],
      ),
      biomeObject(
        "mint-moss-stone",
      ...
      biomeObject(
        ...
        42,
        373,
        ["swap-city-plain", "unicorn-forest"],
        ["path", "grass"],
      ),
      biomeObject(
        "fee-moss-mushrooms",
    ...
    regions: [
      {
        ...
        plants: [
          ...
          },
          {
            plantId: "poolcypress",
            weight: 0.28,
            terrainIds: ["sand", "forest-floor", "swamp"],
          },
        ],
        objects: [
          {
            objectId: "liquidity-reeds",
            weight: 0.48,
            terrainIds: ["water", "sand"],
          },
          ...
          {
            objectId: "mint-pink-marker-stones",
            weight: 0.22,
            terrainIds: ["sand", "water"],
          },
        ],
      ...
      },
      {
        ...
        objects: [
          {
            objectId: "violet-clover-bush",
            weight: 0.38,
            terrainIds: ["grass", "forest-floor"],
          },
          {
            objectId: "mint-moss-stone",
            weight: 0.24,
            terrainIds: ["forest-floor"],
          },
          {
            objectId: "fee-moss-mushrooms",
            weight: 0.3,
            terrainIds: ["forest-floor"],
          },
          {
            objectId: "fallen-unicorn-branch",
            weight: 0.24,
            terrainIds: ["forest-floor"],
          },
          {
            objectId: "forest-root-cluster",
            weight: 0.28,
            terrainIds: ["forest-floor"],
          },
      ...
      },
      {
        ...
        objects: [
          {
            objectId: "round-swap-plaza-stone",
            weight: 0.8,
            terrainIds: ["stone", "plain"],
          },
          {
            objectId: "central-uni-bank",
            weight: 1,
            terrainIds: ["plain", "stone", "path"],
          },
          {
            objectId: "liquidity-lantern",
            weight: 0.3,
            terrainIds: ["path", "stone"],
          },
          {
            objectId: "clover-planter",
            weight: 0.22,
            terrainIds: ["plain", "stone"],
          },
          {
            objectId: "route-silk-grass",
            weight: 0.24,
            terrainIds: ["path", "grass"],
          },
          {
            objectId: "swapstone-pebbles",
            weight: 0.16,
            terrainIds: ["dirt", "stone", "path"],
          },
          {
            objectId: "governance-stone-outcrop",
            weight: 0.18,
            terrainIds: ["stone"],
          },
        ],
      ...
      },
      {
        ...
        plants: [
          ...
          },
          {
            plantId: "starblossom",
            weight: 0.16,
            terrainIds: ["forest-floor", "sand"],
          },
        ],
        objects: [
          {
            objectId: "oracle-glass-crystal",
            weight: 0.5,
            terrainIds: ["swamp", "stone"],
          },
          {
            objectId: "swamp-bubble-moss",
            weight: 0.58,
            terrainIds: ["swamp"],
          },
          {
          ...
          { objectId: "mirror-moss-pad", weight: 0.44, terrainIds: ["swamp"] },
          {
            objectId: "mint-moss-stone",
            weight: 0.26,
            terrainIds: ["swamp", "forest-floor", "stone"],
          },
          {
            objectId: "liquidity-puddle",
            weight: 0.36,
            terrainIds: ["swamp", "water"],
          },
          {
            objectId: "fee-moss-mushrooms",
            weight: 0.28,
