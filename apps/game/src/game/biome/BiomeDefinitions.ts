...
export const biomeDefinitions: Record<string, BiomeDefinition> = {
  ...
  uniswap: {
    ...
    objects: [
      ...
      biomeObject("oracle-glass-crystal", "Oracle Glass Crystal", "decoration", 1, 1, "uniswap-nature-props", 0, 3, 1.12, "scattered", 46, 347, ["oracle-swamp"], ["swamp", "stone"]),
      biomeObject("liquidity-reeds", "Liquidity Reeds", "decoration", 1, 2, "uniswap-nature-props", 1, 0, 1.18, "pool-edge", 68, 359, ["liquidity-lake", "oracle-swamp"], ["water", "sand", "swamp"]),
      ...
      biomeObject("fee-moss-mushrooms", "Fee Moss Mushrooms", "decoration", 1, 1, "uniswap-nature-props", 1, 2, 1, "grove-edge", 48, 389, ["unicorn-forest", "oracle-swamp"], ["forest-floor", "swamp"]),
      ...
      biomeObject("liquidity-puddle", "Liquidity Puddle", "decoration", 1, 1, "uniswap-nature-props", 2, 2, 1.1, "pool-edge", 44, 443, ["liquidity-lake", "oracle-swamp"], ["water", "swamp"], 0.68),
      ...
      biomeObject("swamp-bubble-moss", "Swamp Bubble Moss", "decoration", 1, 1, "uniswap-nature-props", 3, 2, 1.08, "pool-edge", 58, 491, ["oracle-swamp"], ["swamp"]),
      ...
      biomeObject("mirror-moss-pad", "Mirror Moss Pad", "decoration", 1, 1, "uniswap-swamp-props", 0, 2, 1.05, "pool-edge", 52, 631, ["oracle-swamp"], ["swamp"]),
    ],
    regions: [
      {
        id: "liquidity-lake",
      ...
      },
      {
        ...
        label: "Oracle Swamp",
        description:
          "A strange glassy wetland maze with channel water, swamp mats, raised islands, stone outcrops, heavy wetland tree rings, reeds, crystals, and moss pads.",
        anchor: { xRatio: 0.74, yRatio: 0.7 },
        radiusTiles: 46,
        terrains: [
          { terrainId: "swamp", weight: 1.28 },
          { terrainId: "water", weight: 0.68 },
          { terrainId: "sand", weight: 0.42 },
          { terrainId: "forest-floor", weight: 0.58 },
          { terrainId: "grass", weight: 0.24 },
          { terrainId: "stone", weight: 0.18 },
          { terrainId: "dirt", weight: 0.12 },
        ],
        plants: [
          { plantId: "poolblossom", weight: 0.3, terrainIds: ["water", "swamp"] },
          { plantId: "liquidity-reed", weight: 0.32, terrainIds: ["water", "swamp", "sand"] },
          { plantId: "swamp-orchid", weight: 0.48, terrainIds: ["swamp"] },
          { plantId: "mirror-reed", weight: 0.34, terrainIds: ["water", "swamp"] },
          { plantId: "moonwillow", weight: 0.52, terrainIds: ["swamp", "forest-floor", "sand"] },
          { plantId: "poolcypress", weight: 0.62, terrainIds: ["swamp", "sand", "forest-floor"] },
          { plantId: "tickbloom", weight: 0.24, terrainIds: ["forest-floor", "swamp"] },
          { plantId: "starblossom", weight: 0.16, terrainIds: ["forest-floor", "sand"] },
        ],
        objects: [
          { objectId: "oracle-glass-crystal", weight: 0.5, terrainIds: ["swamp", "stone"] },
          { objectId: "swamp-bubble-moss", weight: 0.58, terrainIds: ["swamp"] },
          { objectId: "liquidity-reeds", weight: 0.46, terrainIds: ["swamp", "water", "sand"] },
          { objectId: "mirror-moss-pad", weight: 0.44, terrainIds: ["swamp"] },
          { objectId: "mint-moss-stone", weight: 0.26, terrainIds: ["swamp", "forest-floor", "stone"] },
          { objectId: "liquidity-puddle", weight: 0.36, terrainIds: ["swamp", "water"] },
          { objectId: "fee-moss-mushrooms", weight: 0.28, terrainIds: ["forest-floor", "swamp"] },
        ],
